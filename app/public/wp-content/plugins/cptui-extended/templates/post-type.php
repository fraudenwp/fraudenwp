<?php
/**
 * Single Post Type shortcode template
 *
...
/*
 * This file is used for displaying a single, selected, post type item.
 *
 * It is the template file used when the "Single Post Type" shortcode has been selected in the shortcode builder.
 ...
 *     post_id            // ID of the post type post to display.
 ...
 */
do_action( 'template_single_type_before_title', $attributes ); ?>
 ...
 * @param array $attributes shortcode atrributes.
 */
do_action( 'template_single_type_after_title', $attributes );
...
while ( $custom_query->have_posts() ) : $custom_query->the_post();
	 ...
	 */
	 do_action( 'template_single_type_before_item', $attributes, get_the_ID() ); ?>
	...
	<div id="cptui-<?php the_ID(); ?>" <?php cptui_post_class( 'cptui-entry', $attributes ); ?>>
		...
		<?php if ( 'on' === $attributes['featured_image'] ) : ?>
			<figure class="cptui-entry-thumbnail">
				 ...
				 * @param int   $value      Current post ID.
				 */
				do_action( 'template_single_type_before_featured_image', $attributes, get_the_ID() ); ?>
				...
				<a class="cptui-link" href="<?php the_permalink(); ?>"><?php
					 ...
					 * @param int    $value      Current post ID.
					 */
					the_post_thumbnail( apply_filters( 'template_single_type_thumbnail_size', 'medium', $attributes, get_the_ID() ) ); ?></a>
				 ...
				 * @param int   $value      Current post ID.
				 */
				do_action( 'template_single_type_after_featured_image', $attributes, get_the_ID() ); ?>
		...
		<div class="cptui-entry-header">
			 ...
			 * @param int   $value      Current post ID.
			 */
			do_action( 'template_single_type_before_item_title', $attributes, get_the_ID() ); ?>
			 ...
			 * @param int   $value      Current post ID.
			 */
			do_action( 'template_single_type_after_item_title', $attributes, get_the_ID() ); ?>
		...
		<div class="cptui-entry-summary">
			 ...
			 * @param int   $value      Current post ID.
			 */
			do_action( 'template_single_type_before_excerpt', $attributes, get_the_ID() ); ?>
			 ...
			 * @param int   $value      Current post ID.
			 */
			do_action( 'template_single_type_after_excerpt', $attributes, get_the_ID() ); ?>
	 ...
	 * @param int   $value      Current post ID.
	 */
	do_action( 'template_single_type_after_item', $attributes, get_the_ID() ); ?>
