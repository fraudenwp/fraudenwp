...
<div class="head-item center type-2 fadeup">
	<div class="head-caption">
		<h6>
			Solino Energy bayileri "Enerji Dönüşüm Merkezi" olarak konumlandırılır.
		</h6>
	</div>
</div>
...
<div class="fadeup">
	<div class="content-image-caption">
		<div>
			<img src="/wp-content/uploads/2024/01/bayimizolun-1.jpg">
		</div>
	</div>
</div>
...
<div class="start-scale">
	<div class="image">
		<img src="<?php echo get_stylesheet_directory_uri()?>/assets/images/dealer/dealer.jpg">
	</div>
</div>
-->
...
<div class="head-item fadeup">
	<div class="head-caption">
		<div class="caption">
			<h6>
				Güneş enerjisi sektörüne yön veren 10 yıllık deneyimli bir markanın yanında yer alarak rekabet gücünüzü artırın.
			</h6>
			<div class="item">
				<div class="list">
					<ol>
						<li>
							Solino ailesinin bir parçası olduğunuzda eğitim ve etkinliklerimize katılarak güneş enerjisi konusunda uzmanlaşma fırsatı yakalarsınız. 
						</li>
						<li>
							Yüksek kaliteye sahip ürün donanımımız ve uygulama konusunda 500 kişiden fazla profesyonel destek ekibimiz ile %100 müşteri memnuniyeti sağlarsınız.                             
						</li>
						<li>
							Sıfır hata çalışma prensibimiz sizi sektörde bir adım öne çıkarır.                     
						</li>
					</ol>
				</div>
			</div>
...
<div class="head-item center fadeup">
	<div class="head-caption">
		<h6>
			Solino ile çalışmanız için <br>10 neden!
		</h6>
	</div>
</div>

<section class="icon-content row">
	<div class="col-6 item fadeup">
		<img src="<?php echo get_stylesheet_directory_uri()?>/assets/images/pages/dealer/icons/uygun.svg">
		Uygun koşullarda A+ kalite ürün tedariği 
	</div>
	<div class="col-6 item fadeup">
		<img src="<?php echo get_stylesheet_directory_uri()?>/assets/images/pages/dealer/icons/edm.svg">
		 Ciro paylaşımı 
	</div>

	<div class="col-6 item fadeup">
		<img src="<?php echo get_stylesheet_directory_uri()?>/assets/images/pages/dealer/icons/reklam.svg">
		Reklam desteği 
	</div>
	<div class="col-6 item fadeup">
		<img src="<?php echo get_stylesheet_directory_uri()?>/assets/images/pages/dealer/icons/crm.svg">
		CRM altyapısından faydalanma 
	</div>

	<div class="col-6 item fadeup">
		<img src="<?php echo get_stylesheet_directory_uri()?>/assets/images/pages/dealer/icons/nitelikli-musteri.svg">
		Nitelikli müşteri yönlendirme
	</div>
	<div class="col-6 item fadeup">
		<img src="<?php echo get_stylesheet_directory_uri()?>/assets/images/pages/dealer/icons/musteri-odeme.svg">
		Müşteriye ödeme kolaylığı sağlanması 
	</div>

	<div class="col-6 item fadeup">
		<img src="<?php echo get_stylesheet_directory_uri()?>/assets/images/pages/dealer/icons/kurumsal.svg">
		Kurumsal kimlik
	</div>
	<div class="col-6 item fadeup">
		<img src="<?php echo get_stylesheet_directory_uri()?>/assets/images/pages/dealer/icons/bakim.svg">
		Bakım onarım anlaşması 
		desteği
	</div>

	<div class="col-6 item fadeup">
		<img src="<?php echo get_stylesheet_directory_uri()?>/assets/images/pages/dealer/icons/kampanya.svg">
		Kampanyalardan faydalanma
	</div>

	  <div class="col-6 item fadeup">
		<img src="<?php echo get_stylesheet_directory_uri()?>/assets/images/pages/dealer/icons/egitim.svg">
		Eğitim
	</div>
</section>
