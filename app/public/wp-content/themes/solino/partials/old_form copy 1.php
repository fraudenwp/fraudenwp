	...
	<div class="content persFormC">
		...
		<div class="form">
			...
			<div id="formArea">	
				...
				<form class="row" id="applyForm">
					<div class="col-6 item errItem">
						<input type="text" id="fName" name="fName" placeholder="İsim Soyad*" autocomplete="off" required>
					</div>
					<div class="col-6 item errItem">
						<input type="tel" id="fPhone" name="fPhone" placeholder="Telefon*" autocomplete="off" minlength="14" maxlength="14" class="phoneMask" required>
					</div>
					<div class="col-6 item errItem">
						<div class="selectbox">
					...
					<div class="col-6 item errItem">
						<div class="selectbox">
							<select class="selectric-select" id="mustakil" autocomplete="off" name="mustakil" required>
								<option value="">Eviniz Müstakil mi?*</option>
